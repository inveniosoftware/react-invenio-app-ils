...
class LiteratureCardGroup extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  renderCards() {
    ...
    return data.hits.map(book => {
      return <LiteratureCard key={book.metadata.pid} data={book} />;
    });
  }
  ...
  render() {
    ...
    return (
      <Overridable id="LiteratureCardGroup.layout" {...this.props}>
        <>
...
LiteratureCardGroup.defaultProps = {
  headerClass: '',
};
