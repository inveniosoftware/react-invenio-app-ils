...
import SeriesMetadataAccordionComponent from './SeriesMetadataAccordion';
import SeriesMetadataTabsComponent from './SeriesMetadataTabs';
...
export const SeriesInfo = connect(mapStateToProps, null)(SeriesInfoComponent);

export const SeriesLinks = connect(mapStateToProps, null)(SeriesLinksComponent);
...
export const SeriesTitle = connect(mapStateToProps, null)(SeriesTitleComponent);

export const SeriesUrls = connect(mapStateToProps, null)(SeriesUrlsComponent);
