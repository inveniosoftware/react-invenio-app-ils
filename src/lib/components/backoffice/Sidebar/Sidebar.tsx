...
import { User } from '@authentication/services/SessionManager';
...
interface SidebarProps {
  ...
  user: User;
  logout: () => Promise<void>;
  sendErrorNotification: (title: string, message: string) => void;
}
...
class Sidebar extends Component<SidebarProps> {
  ...
  removeTrailingSlashes = (path: string) => path.replace(/\/+$/, '');
