        ...
        <Table definition>
          <Table.Body>
            <Table.Row>
              ...
              <Table.Cell>{patron_loan.loan.extension_count || 0}</Table.Cell>
            </Table.Row>
          </Table.Body>
        </Table>
                  ...
                  <Grid.Column width={8} textAlign="left">
                    ...
                    >
                      ...
                      <Modal.Content>
                        ...
                        <Label basic>{patron_loan.loan.end_date}</Label>
                        <Divider hidden />
                        <Form>
                          <Form.Group>
...
BorrowingRequestLoanExtension.propTypes = {
  patron_loan: PropTypes.object.isRequired,
