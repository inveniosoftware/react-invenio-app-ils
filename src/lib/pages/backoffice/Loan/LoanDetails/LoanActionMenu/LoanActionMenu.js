    ...
    return (
      <div className="bo-action-menu">
        ...
        <Message size="small">
          ...
          <p>
            Loans cannot be deleted. You can manage the loans by using the the
            the actions available in the Loan panel on the left. You can change
            the dates by clicking on the button above.
          </p>
        </Message>
