...
describe('Document stats fetch tests', () => {
  it('should dispatch a loading action when fetching document stats', async () => {
    const expectedAction = {
      type: actions.IS_LOADING,
    };
    await store.dispatch(actions.fetchDocumentStats(ARGS));
  ...
  it('should dispatch a success action when document stats fetch succeeds', async () => {
  ...
  it('should dispatch an error action when document stats fetch fails', async () => {
